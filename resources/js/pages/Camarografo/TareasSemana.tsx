            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
                ...
                <div className="mb-8 rounded-2xl bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 p-8 shadow-2xl">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-4xl font-bold text-white">Grabaciones de Esta Semana</h1>
                    </div>
                    <p className="mt-2 text-purple-100">Visualiza tus producciones semanales</p>
                </div>
                                    ...
                                    <div className="space-y-4 p-4">
                                        {tareasDelDia.length === 0 ? (
                                            <div className="py-8 text-center text-gray-400">
                                                ...
                                                <p className="mt-2">Sin grabaciones programadas</p>
                                            </div>
                                        ) : (
                                                ...
                                                >
                                                    ...
                                                    <div className="mb-2 flex items-center gap-2">
                                                        <Chip
                                                            ...
                                                            size="small"
                                                            icon={tarea.estado_produccion === 'completado' ? <CheckCircleIcon /> : <PendingIcon />}
                                                            sx={{
                                                                bgcolor: tarea.estado_produccion === 'completado' ? '#d1fae5' : '#fef3c7',
                                                                color: tarea.estado_produccion === 'completado' ? '#065f46' : '#92400e',
                                                                fontWeight: 'bold',
                                                                '& .MuiChip-icon': {
                                                                    color: tarea.estado_produccion === 'completado' ? '#10b981' : '#f59e0b',
                                                                },
                                                            }}
                                                        />
                                                    </div>
