...
export default function SeguimientoTareas({
    ...
    const [semanaNueva, setSemanaNueva] = useState('');
        ...
        <AppLayout>
            ...
            <div className="p-6">
                ...
                <div className="mb-8 rounded-lg bg-white p-4 shadow">
                    <h3 className="mb-2 text-lg font-semibold text-gray-700">➕ Crear nueva tarea</h3>
                    <div className="flex items-center space-x-4">
                        {/* Campo de título fijo */}
                        <input
                            type="text"
                            value="Video nuevo"
                            disabled
                            className="w-40 cursor-not-allowed rounded border bg-gray-100 px-3 py-2 text-gray-600"
                        />

                        {/* Selección de semana */}
                        <select value={semanaNueva} onChange={(e) => setSemanaNueva(e.target.value)} className="rounded border px-3 py-2">
                        ...
                        <button
                            onClick={() => {
                                ...
                                router.post(
                                    route('tareas.store', empresa.id),
                                    {
                                        titulo: 'Video nuevo',
                                        semana: semanaNueva,
                                        mes: mesFiltro || mesActual,
                                        anio: anioFiltro || anioActual,
                                    },
                                    { preserveScroll: true },
                                );

                                setSemanaNueva(''); // limpiar select
                            }}
