...
const GradientButton = styled(Button)(({ theme }) => ({
    ...
    '&:hover': {
        ...
        boxShadow: '0 6px 10px 4px rgba(255, 107, 107, .3)',
    },
            ...
            <Container maxWidth="lg" sx={{ py: 6 }}>
                            ...
                            <Box display="flex" alignItems="center" gap={2}>
                                ...
                                <Box>
                                    ...
                                    <Typography variant="h6" sx={{ opacity: 0.9 }}>
                                        Modifica la información de tu informe existente
                                    </Typography>
                                    <Chip 
                                        icon={<CheckCircle />}
                                        label={`ID: ${informe.id}`} 
                ...
                >
                    <Typography variant="body1" fontWeight="medium">
                        📝 Estás editando el informe: <strong>"{informe.titulo}"</strong>
                    </Typography>
                </Alert>
                                ...
                                <Grid item xs={12}>
                                    <Box display="flex" justifyContent="space-between" alignItems="center">
                                        ...
                                        <GradientButton
                                            ...
                                            size="large"
                                            disabled={processing}
                                            startIcon={processing ? null : <Update />}
                                            endIcon={processing ? (
                                                <Box 
                                                    sx={{ 
                                                        width: 20, 
                                        ...
                                        >
                                            {processing ? 'Actualizando...' : 'Actualizar Informe'}
                                        </GradientButton>
                                    </Box>
                                </Grid>
                            </Grid>
