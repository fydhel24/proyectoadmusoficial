...
export default function SeguimientoVideos({ empresa, videos }: Props) {
    ...
    // Agrupa los videos por semana usando useMemo para optimizar el rendimiento.
    const videosAgrupados = useMemo(() => {
        ...
        // Opcional: Ordenar las semanas para asegurar que se muestren en orden numérico
        ...
        <AppLayout>
            ...
            <div className="container mx-auto p-6">
                <div className="mb-6 flex items-center justify-between">
                    ...
                    <button onClick={() => { setShowModal(true); resetForm(); }} className="rounded bg-green-600 px-4 py-2 text-white hover:bg-green-700">
                        Crear Video
                    </button>
                </div>

                {/* Mostrar la tabla si hay videos, de lo contrario un mensaje */}
                {Object.keys(videosAgrupados).length > 0 ? (
                    Object.keys(videosAgrupados).map(semana => (
                        <div key={semana} className="mb-8">
                            <h2 className="text-xl font-semibold mb-4 bg-gray-200 p-2 rounded-t-md border-b-2 border-gray-300">
                                {semana}
                            </h2>
                    ...
                    <div className="text-center text-gray-500 py-10">No hay videos de seguimiento registrados para esta empresa.</div>
                )}
                    ...
                    <div className="bg-opacity-50 fixed inset-0 z-50 flex items-center justify-center bg-black">
                        <div className="w-full max-w-3xl rounded-lg bg-white p-6 shadow-lg">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                {/* Campos de estado solo para creación, no para edición */}
                                {!editingVideoId && (
                                    <>
                                        <div>
