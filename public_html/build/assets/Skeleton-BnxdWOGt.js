import{r as v,j as C}from"./app-C9FYWxt2.js";import{c as b}from"./clsx-B-dksMZM.js";import{b as k,g as w,u as x,s as R,c as S,m as $,a as U}from"./DefaultPropsProvider-ZncIBFYl.js";import{a as u,k as c}from"./Typography-ChZrof4A.js";function M(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function A(t){return parseFloat(t)}function X(t){return k("MuiSkeleton",t)}w("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const j=t=>{const{classes:e,variant:a,animation:n,hasChildren:s,width:i,height:o}=t;return S({root:["root",a,n,s&&"withChildren",s&&!i&&"fitContent",s&&!o&&"heightAuto"]},X,e)},r=c`
  0% {
    opacity: 1;
  }
