import{r as v,j as C}from"./app-iQxetvcT.js";import{c as b}from"./clsx-B-dksMZM.js";import{a as k,g as w,u as x,s as R,c as S,m as $,b as U}from"./DefaultPropsProvider-ByswQ0ug.js";import{a as u,k as c}from"./createSimplePaletteValueFilter-DBX30MBl.js";function M(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function A(t){return parseFloat(t)}function X(t){return k("MuiSkeleton",t)}w("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const j=t=>{const{classes:e,variant:a,animation:n,hasChildren:s,width:i,height:o}=t;return S({root:["root",a,n,s&&"withChildren",s&&!i&&"fitContent",s&&!o&&"heightAuto"]},X,e)},r=c`
  0% {
    opacity: 1;
  }
